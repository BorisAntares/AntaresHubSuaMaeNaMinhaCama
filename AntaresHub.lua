...
local Window = OrionLib:MakeWindow({Name = "O Fim deste loadstring.", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest", introText = Antares})
